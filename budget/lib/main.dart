...
void main() async {
  captureLogs(() async {
    ...
    appStateSettings["previewDemo"] = false;
...
class _InitializeAppState extends State<InitializeApp> {
  ...
  void _preloadImages() {
    // Preload images for landing pages
    precacheImage(AssetImage('assets/landing/PigBank.webp'), context);
    precacheImage(AssetImage('assets/landing/Graph.webp'), context);
    precacheImage(AssetImage('assets/landing/BankOrPig.webp'), context);
  }
